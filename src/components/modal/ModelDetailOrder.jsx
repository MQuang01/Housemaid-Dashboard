...
const ModelDetailOrder = ({ show, handleClose, data, handleUpdateStatusOrder }) => {
  return (
    <>
        <Modal show={show} onHide={handleClose} size='lg'>
            ...
            <div className="col-xl-12">
                  ...
                  <div className="nav-align-top mb-4">
                    ...
                    <div class="tab-content">
                      <div class="tab-pane fade show active" id="navs-justified-customer" role="tabpanel">
                        <div class="row">
                            <label class="col-md-3 col-form-label fw-bold">Họ và tên</label>
                            <div class="col-md-9">
                        ...
                        <div class="row">
                            <label class="col-md-3 col-form-label fw-bold">Số điện thoại</label>
                            <div class="col-md-9">
                                <p className='form-control'>{data?.user?.phone}</p>
                            </div>
                        </div>
                        <div class="row">
                            <label class="col-md-3 col-form-label fw-bold">Giới tính</label>
                            <div class="col-md-9">
                                <p className='form-control'>{data?.user?.gender}</p>
                            </div>
                        </div>
                      </div>
                    <div class="tab-pane fade" id="navs-justified-order-detail" role="tabpanel">
                                ...
                                <tbody>
                                    {data?.listOrderDetail.map((orderDetail, index) => (
                                        <tr key={orderDetail.id}>
                                            ...
                                            <td>{orderDetail.quantity} {orderDetail.house_size === null ? "sản phẩm" : "m2"}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
            ...
            <ModalFooter>
                <Button variant="success" 
                    onClick={() => {
                            const isConfirmed = window.confirm("Bạn muốn chấp nhận đơn hàng có mã: " + data.currentlyCode + " này?");
                            if (isConfirmed) {
                ...
                <Button variant="danger"
                    onClick={() => {
                            const isConfirmed = window.confirm("Bạn muốn hủy đơn hàng có mã: " + data.currentlyCode + " này?");
                            if (isConfirmed) {
