            ...
            <div className="layout-page">
                ...
                <div className="content-wrapper">
                    <div className="container-xxl flex-grow-1 container-p-y">
                        <h4 className="fw-bold py-3 mb-2"><span className="text-muted fw-light">Dữ liệu /</span> Quản lý hóa đơn</h4>
                        ...
                        <div className="card">
                            <div className="card-header">
                                <div className="d-flex justify-content-between align-items-center">
                                    <button className="btn btn-primary btn-lm" onClick={handleShowCreateModal}>Tạo hóa đơn</button>
                                </div>
                            </div>
                                ...
                                <table className="table table-light table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Mã đơn</th>
                                            <th>Tổng giá tiền</th>
                                            <th style={{ textAlign: 'right' }}>Ngày ủy thác</th>
                                            <th style={{ textAlign: 'right' }}>Thời gian bắt đầu</th>
